...
public class TextureStorage {
    static TextureAttribute[][] textures3d = new TextureAttribute[16][2];
    static Texture[][] textures2d = new Texture[16][2];
    ...
    public TextureStorage() {
        ...
        TextureAttribute simple3D_texture7 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("crown.png"));
        temp3d.add(simple3D_texture7);
        TextureAttribute selected3D_texture7 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("crown_selected.png"));
        temp3d.add(selected3D_texture7);
        Texture simple_2Dtexture7 = new Texture(Gdx.files.internal("crown3d.png"));
        temp2d.add(simple_2Dtexture7);
        Texture selected_2Dtexture7 = new Texture(Gdx.files.internal("crown3d_selected.png"));
        temp2d.add(selected_2Dtexture7);
        TextureAttribute simple3D_texture8 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("princess.png"));
        temp3d.add(simple3D_texture8);
        TextureAttribute selected3D_texture8 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("princess_selected.png"));
        temp3d.add(selected3D_texture8);
        Texture simple_2Dtexture8 = new Texture(Gdx.files.internal("princess3d.png"));
        temp2d.add(simple_2Dtexture8);
        Texture selected_2Dtexture8 = new Texture(Gdx.files.internal("princess3d_selected.png"));
        temp2d.add(selected_2Dtexture8);
        TextureAttribute simple3D_texture9 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("smallknight.png"));
        temp3d.add(simple3D_texture9);
        TextureAttribute selected3D_texture9 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("smallknight_selected.png"));
        temp3d.add(selected3D_texture9);
        Texture simple_2Dtexture9 = new Texture(Gdx.files.internal("smallknight3d.png"));
        temp2d.add(simple_2Dtexture9);
        Texture selected_2Dtexture9= new Texture(Gdx.files.internal("smallknight3d_selected.png"));
        temp2d.add(selected_2Dtexture9);
        TextureAttribute simple3D_texture10 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("solntselikiy.png"));
        temp3d.add(simple3D_texture10);
        TextureAttribute selected3D_texture10 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("solntselikiy_selected.png"));
        temp3d.add(selected3D_texture10);
        Texture simple_2Dtexture10 = new Texture(Gdx.files.internal("solntselikiy3d.png"));
        temp2d.add(simple_2Dtexture10);
        Texture selected_2Dtexture10 = new Texture(Gdx.files.internal("solntselikiy3d_selected.png"));
        temp2d.add(selected_2Dtexture10);
        TextureAttribute simple3D_texture11 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("spellbook.png"));
        temp3d.add(simple3D_texture11);
        TextureAttribute selected3D_texture11 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("spellbook_selected.png"));
        temp3d.add(selected3D_texture11);
        Texture simple_2Dtexture11 = new Texture(Gdx.files.internal("spellbook3d.png"));
        temp2d.add(simple_2Dtexture11);
        Texture selected_2Dtexture11 = new Texture(Gdx.files.internal("spellbook3d_selected.png"));
        temp2d.add(selected_2Dtexture11);
        TextureAttribute simple3D_texture12 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("stranger.png"));
        temp3d.add(simple3D_texture12);
        TextureAttribute selected3D_texture12 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("stranger_selected.png"));
        temp3d.add(selected3D_texture12);
        Texture simple_2Dtexture12 = new Texture(Gdx.files.internal("stranger3d.png"));
        temp2d.add(simple_2Dtexture12);
        Texture selected_2Dtexture12 = new Texture(Gdx.files.internal("stranger3d_selected.png"));
        temp2d.add(selected_2Dtexture12);
        TextureAttribute simple3D_texture13 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("summon.png"));
        temp3d.add(simple3D_texture13);
        TextureAttribute selected3D_texture13 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("summon_selected.png"));
        temp3d.add(selected3D_texture13);
        Texture simple_2Dtexture13 = new Texture(Gdx.files.internal("summon3d.png"));
        temp2d.add(simple_2Dtexture13);
        Texture selected_2Dtexture13 = new Texture(Gdx.files.internal("summon3d_selected.png"));
        temp2d.add(selected_2Dtexture13);
        TextureAttribute simple3D_texture14 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("twinbranches.png"));
        temp3d.add(simple3D_texture14);
        TextureAttribute selected3D_texture14 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("twinbranches_selected.png"));
        temp3d.add(selected3D_texture14);
        Texture simple_2Dtexture14= new Texture(Gdx.files.internal("twinbranches3d.png"));
        temp2d.add(simple_2Dtexture14);
        Texture selected_2Dtexture14 = new Texture(Gdx.files.internal("twinbranches3d_selected.png"));
        temp2d.add(selected_2Dtexture14);
        TextureAttribute simple3D_texture15 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("vampire.png"));
        temp3d.add(simple3D_texture15);
        TextureAttribute selected3D_texture15 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("vampire_selected.png"));
        temp3d.add(selected3D_texture15);
        Texture simple_2Dtexture15 = new Texture(Gdx.files.internal("vampire3d.png"));
        temp2d.add(simple_2Dtexture15);
        Texture selected_2Dtexture15 = new Texture(Gdx.files.internal("vampire3d_selected.png"));
        temp2d.add(selected_2Dtexture15);
        TextureAttribute simple3D_texture16 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("zdorovyak.png"));
        temp3d.add(simple3D_texture16);
        TextureAttribute selected3D_texture16 = new TextureAttribute(TextureAttribute.Diffuse, new Texture("zdorovyak_selected.png"));
        temp3d.add(selected3D_texture16);
        Texture simple_2Dtexture16 = new Texture(Gdx.files.internal("zdorovyak3d.png"));
        temp2d.add(simple_2Dtexture16);
        Texture selected_2Dtexture16 = new Texture(Gdx.files.internal("zdorovyak3d_selected.png"));
